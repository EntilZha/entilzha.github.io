#!/usr/bin/env python3
"""Generate src/data/publications.ts from content/pages/publications.bib.
...
BIB = ROOT / "content" / "pages" / "publications.bib"
...
def main():
    ...
    ts = (
        ...
        "// content/pages/publications.bib — do not edit by hand.\n\n"
